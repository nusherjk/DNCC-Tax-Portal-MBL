...
urlpatterns = [
    ...
    path('taxValidation', taxValidation, name="taxValidation"),
    path('confirmation/<txn>', confirmation, name="confirmation"),
    path('submitTax/<txn>', submitTax, name="submitTax"),
	...
	#path('downloadUserCreationForm', download, name='user create'),
